...
### `e5c4410` — Update CH33ZE template documentation
- Author: `CH33ZE`
...
### `9ca6e62` — Update CH33ZE template documentation
- Author: `CH33ZE`
...
### `5706383` — Update CH33ZE template documentation
- Author: `CH33ZE`
- Diff: `1 file changed, 7 insertions(+)`
- Change counts: `files=1, insertions=7, deletions=0`
- Changed paths:
...
### `5e1c362` — Update CH33ZE template documentation
- Author: `CH33ZE`
- Diff: `1 file changed, 7 insertions(+)`
- Change counts: `files=1, insertions=7, deletions=0`
- Changed paths:
...
### `3c52eb1` — Update CH33ZE template documentation
- Author: `CH33ZE`
- Diff: `1 file changed, 7 insertions(+)`
- Change counts: `files=1, insertions=7, deletions=0`
- Changed paths:
...
### `190f7b5` — Update CH33ZE template documentation
- Author: `CH33ZE`
...
### `5d87d90` — Update CH33ZE template documentation
- Author: `CH33ZE`
...
### `13b6828` — Expand CH33ZE template docs
- Author: `CH33ZE`
- Diff: `6 files changed, 47 insertions(+), 5 deletions(-)`
- Change counts: `files=6, insertions=47, deletions=5`
- Changed paths:
  - `M	LICENSE`
  - `M	README.md`
  - `A	docs/app-setup-order.md`
  - `A	docs/operations.md`
  - `A	docs/service-wiring.md`
  - `R081	docs/sanitization.md	docs/template-notes.md`

### `0ca35e1` — Publish media automation stack template
- Author: `CH33ZE`
- Diff: `8 files changed, 336 insertions(+)`
- Change counts: `files=8, insertions=336, deletions=0`
- Changed paths:
  - `A	.env.example`
  - `A	.gitignore`
  - `A	LICENSE`
  ...
  - `A	docs/path-contract.md`
  - `A	docs/sanitization.md`
  - `A	docs/vpn-qbittorrent.md`
